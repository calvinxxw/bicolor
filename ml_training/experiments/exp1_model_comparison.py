...
def test_xgboost(X_train, y_train, X_test, y_test, df, split_idx):
    """Test XGBoost model"""
    print("\n" + "="*60)
    ...
    for num_idx in range(33):
        ...
        model.fit(X_train, y_train[:, num_idx], verbose=False)
...
if __name__ == '__main__':
    print("Experiment 1: Model Complexity Comparison")
    print("="*60)
    ...
    # Test all models
    results = {}
    results['xgboost'] = test_xgboost(X_train, y_train, X_test, y_test, df, split_idx)
